...
public class SignatureVerificationMiddleware
{
    ...
    {
        // Extraer los headers de autenticación de SOLUSOL
        ...
        context.Request.Headers.TryGetValue("TenantId", out var tenantId); // Capturar también el TenantId
        ...
        // Si la verificación es exitosa, propagar el TenantId a través del contexto de la petición
